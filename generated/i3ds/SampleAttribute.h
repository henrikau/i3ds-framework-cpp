...
#define T_String16_REQUIRED_BYTES_FOR_ENCODING       17 
#define T_String16_REQUIRED_BITS_FOR_ENCODING        133
#define T_String16_REQUIRED_BYTES_FOR_ACN_ENCODING   17 
#define T_String16_REQUIRED_BITS_FOR_ACN_ENCODING    133
#define T_String16_REQUIRED_BYTES_FOR_XER_ENCODING   57

void T_String16_Initialize(T_String16* pVal);
flag T_String16_IsConstraintValid(const T_String16* val, int* pErrCode);
#ifndef ERR_T_String16 
#define ERR_T_String16		1003  /*(SIZE(0 .. 16))*/
#endif
...
typedef struct {
    ...
    union {
        ...
        T_Double real_value;
        T_String16 string_value;
    } u; 
} Attribute_value_t;

#define Attribute_value_t_REQUIRED_BYTES_FOR_ENCODING       17 
#define Attribute_value_t_REQUIRED_BITS_FOR_ENCODING        136
#define Attribute_value_t_REQUIRED_BYTES_FOR_ACN_ENCODING   17 
#define Attribute_value_t_REQUIRED_BITS_FOR_ACN_ENCODING    136
...
#define Sample_attribute_t_REQUIRED_BYTES_FOR_ENCODING       18 
#define Sample_attribute_t_REQUIRED_BITS_FOR_ENCODING        144
#define Sample_attribute_t_REQUIRED_BYTES_FOR_ACN_ENCODING   18 
#define Sample_attribute_t_REQUIRED_BITS_FOR_ACN_ENCODING    144
...
typedef struct {    int nCount; 
    ...
    Sample_attribute_t arr[5];
} SampleAttributes_attributes;

#define SampleAttributes_attributes_REQUIRED_BYTES_FOR_ENCODING       91 
#define SampleAttributes_attributes_REQUIRED_BITS_FOR_ENCODING        723
#define SampleAttributes_attributes_REQUIRED_BYTES_FOR_ACN_ENCODING   91 
#define SampleAttributes_attributes_REQUIRED_BITS_FOR_ACN_ENCODING    723
#define SampleAttributes_attributes_REQUIRED_BYTES_FOR_XER_ENCODING   1069
...
#define ERR_SampleAttributes_attributes		1005  /*(SIZE(0 .. 5))*/
#endif
...
#define SampleAttributes_REQUIRED_BYTES_FOR_ENCODING       103 
#define SampleAttributes_REQUIRED_BITS_FOR_ENCODING        821
#define SampleAttributes_REQUIRED_BYTES_FOR_ACN_ENCODING   103 
#define SampleAttributes_REQUIRED_BITS_FOR_ACN_ENCODING    821
#define SampleAttributes_REQUIRED_BYTES_FOR_XER_ENCODING   1237
...
flag T_String16_Encode(const T_String16* val, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints);
...
flag Sample_attribute_t_Encode(const Sample_attribute_t* val, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints);
flag Sample_attribute_t_Decode(Sample_attribute_t* pVal, BitStream* pBitStrm, int* pErrCode);
flag SampleAttributes_attributes_Encode(const SampleAttributes_attributes* val, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints);
