...
{
    *pVal = (RadarMeasurement400K_validity) {    .nCount = 1,    .arr = 
    {
        valid_measurement        
    }
};
...
flag RadarMeasurement400K_validity_Encode(const RadarMeasurement400K_validity* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints)
{
    flag ret = TRUE;
	int i1=0;
...
{
    *pVal = (RadarMeasurement200K_validity) {    .nCount = 1,    .arr = 
    {
        valid_measurement        
    }
};
...
flag RadarMeasurement200K_validity_IsConstraintValid(const RadarMeasurement200K_validity* pVal, int* pErrCode)
{
	...
	*pErrCode = ret ? 0 : ERR_RadarMeasurement200K_validity;
	i1 = 0;
	while (ret && (i1< pVal->nCount)) {
	    ret = Depth_validity_t_IsConstraintValid(&pVal->arr[i1], pErrCode);
	    i1 = i1+1;
...
flag RadarMeasurement200K_validity_Encode(const RadarMeasurement200K_validity* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints)
{
    flag ret = TRUE;
	int i1=0;
    
	ret = bCheckConstraints ? RadarMeasurement200K_validity_IsConstraintValid(pVal, pErrCode) : TRUE ;
	if (ret) {
	    {
	    	asn1SccSint nCount1 = pVal->nCount;
	    	asn1SccSint curBlockSize1 = 0;
...
{
    *pVal = (RadarMeasurement100K_validity) {    .nCount = 1,    .arr = 
    {
        valid_measurement        
    }
};
...
flag RadarMeasurement100K_validity_IsConstraintValid(const RadarMeasurement100K_validity* pVal, int* pErrCode)
{
	...
	*pErrCode = ret ? 0 : ERR_RadarMeasurement100K_validity;
	i1 = 0;
	while (ret && (i1< pVal->nCount)) {
	    ret = Depth_validity_t_IsConstraintValid(&pVal->arr[i1], pErrCode);
	    i1 = i1+1;
...
flag RadarMeasurement100K_validity_Encode(const RadarMeasurement100K_validity* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints)
{
    flag ret = TRUE;
	int i1=0;
    
	ret = bCheckConstraints ? RadarMeasurement100K_validity_IsConstraintValid(pVal, pErrCode) : TRUE ;
	if (ret) {
	    {
	    	asn1SccSint nCount1 = pVal->nCount;
	    	asn1SccSint curBlockSize1 = 0;
...
{
    *pVal = (RadarMeasurement400K_distances) {    .nCount = 1,    .arr = 
    {
...
flag RadarMeasurement400K_distances_Encode(const RadarMeasurement400K_distances* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints)
{
    flag ret = TRUE;
	int i1=0;
...
{
    *pVal = (RadarMeasurement200K_distances) {    .nCount = 1,    .arr = 
    {
        0.00000000000000000000E+000        
    }
};
...
flag RadarMeasurement200K_distances_IsConstraintValid(const RadarMeasurement200K_distances* pVal, int* pErrCode)
{
	...
	*pErrCode=0;
	...
	ret = (1 <= pVal->nCount && pVal->nCount <= 200000);
	*pErrCode = ret ? 0 : ERR_RadarMeasurement200K_distances;
	i1 = 0;
	while (ret && (i1< pVal->nCount)) {
	    ret = T_Float_IsConstraintValid(&pVal->arr[i1], pErrCode);
	    i1 = i1+1;
...
flag RadarMeasurement200K_distances_Encode(const RadarMeasurement200K_distances* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints)
{
    flag ret = TRUE;
	int i1=0;
    
	ret = bCheckConstraints ? RadarMeasurement200K_distances_IsConstraintValid(pVal, pErrCode) : TRUE ;
	if (ret) {
	    {
	    	asn1SccSint nCount1 = pVal->nCount;
	    	asn1SccSint curBlockSize1 = 0;
...
{
    *pVal = (RadarMeasurement100K_distances) {    .nCount = 1,    .arr = 
    {
        0.00000000000000000000E+000        
    }
};
...
flag RadarMeasurement100K_distances_IsConstraintValid(const RadarMeasurement100K_distances* pVal, int* pErrCode)
{
	...
	*pErrCode=0;
	...
	ret = (1 <= pVal->nCount && pVal->nCount <= 100000);
	*pErrCode = ret ? 0 : ERR_RadarMeasurement100K_distances;
	i1 = 0;
	while (ret && (i1< pVal->nCount)) {
	    ret = T_Float_IsConstraintValid(&pVal->arr[i1], pErrCode);
	    i1 = i1+1;
...
flag RadarMeasurement100K_distances_Encode(const RadarMeasurement100K_distances* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints)
{
    flag ret = TRUE;
	int i1=0;
    
	ret = bCheckConstraints ? RadarMeasurement100K_distances_IsConstraintValid(pVal, pErrCode) : TRUE ;
	if (ret) {
	    {
	    	asn1SccSint nCount1 = pVal->nCount;
	    	asn1SccSint curBlockSize1 = 0;
...
flag RadarMeasurement100K_IsConstraintValid(const RadarMeasurement100K* pVal, int* pErrCode)
{
	...
	*pErrCode=0;
	...
	if (ret) {
	    ret = RadarMeasurement100K_distances_IsConstraintValid(&pVal->distances, pErrCode);
	    if (ret) {
	        ret = RadarMeasurement100K_validity_IsConstraintValid(&pVal->validity, pErrCode);
	        if (ret) {
...
flag RadarMeasurement100K_Encode(const RadarMeasurement100K* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints)
{
    flag ret = TRUE;
    
	ret = bCheckConstraints ? RadarMeasurement100K_IsConstraintValid(pVal, pErrCode) : TRUE ;
	if (ret) {
	    /*Encode attributes */
	    ret = SampleAttributes_Encode(&pVal->attributes, pBitStrm, pErrCode, FALSE);
	    if (ret) {
	        /*Encode distances */
	        ret = RadarMeasurement100K_distances_Encode(&pVal->distances, pBitStrm, pErrCode, FALSE);
	        if (ret) {
	            /*Encode validity */
	            ret = RadarMeasurement100K_validity_Encode(&pVal->validity, pBitStrm, pErrCode, FALSE);
	            if (ret) {
	                /*Encode region */
...
flag RadarMeasurement100K_Decode(RadarMeasurement100K* pVal, BitStream* pBitStrm, int* pErrCode)
{
	...
	if (ret) {
	    /*Decode distances */
	    ret = RadarMeasurement100K_distances_Decode(&pVal->distances, pBitStrm, pErrCode);
	    if (ret) {
	        /*Decode validity */
	        ret = RadarMeasurement100K_validity_Decode(&pVal->validity, pBitStrm, pErrCode);
	        if (ret) {
	            /*Decode region */
...
flag RadarMeasurement200K_IsConstraintValid(const RadarMeasurement200K* pVal, int* pErrCode)
{
	...
	*pErrCode=0;
	...
	ret = SampleAttributes_IsConstraintValid(&pVal->attributes, pErrCode);
	if (ret) {
	    ret = RadarMeasurement200K_distances_IsConstraintValid(&pVal->distances, pErrCode);
	    if (ret) {
	        ret = RadarMeasurement200K_validity_IsConstraintValid(&pVal->validity, pErrCode);
	        if (ret) {
	            ret = PlanarRegion_IsConstraintValid(&pVal->region, pErrCode);
...
flag RadarMeasurement200K_Encode(const RadarMeasurement200K* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints)
{
    flag ret = TRUE;
    
	ret = bCheckConstraints ? RadarMeasurement200K_IsConstraintValid(pVal, pErrCode) : TRUE ;
	if (ret) {
	    /*Encode attributes */
	    ret = SampleAttributes_Encode(&pVal->attributes, pBitStrm, pErrCode, FALSE);
	    if (ret) {
	        /*Encode distances */
	        ret = RadarMeasurement200K_distances_Encode(&pVal->distances, pBitStrm, pErrCode, FALSE);
	        if (ret) {
	            /*Encode validity */
	            ret = RadarMeasurement200K_validity_Encode(&pVal->validity, pBitStrm, pErrCode, FALSE);
	            if (ret) {
	                /*Encode region */
	                ret = PlanarRegion_Encode(&pVal->region, pBitStrm, pErrCode, FALSE);
...
flag RadarMeasurement200K_Decode(RadarMeasurement200K* pVal, BitStream* pBitStrm, int* pErrCode)
{
	...
	if (ret) {
	    /*Decode distances */
	    ret = RadarMeasurement200K_distances_Decode(&pVal->distances, pBitStrm, pErrCode);
	    if (ret) {
	        /*Decode validity */
	        ret = RadarMeasurement200K_validity_Decode(&pVal->validity, pBitStrm, pErrCode);
	        if (ret) {
	            /*Decode region */
	            ret = PlanarRegion_Decode(&pVal->region, pBitStrm, pErrCode);
